...
(provide
 (strip-colon-prefix-out
  ...
  6:even? 6:exact 6:exact-integer-sqrt r:exact-integer? 6:exact? 6:expt features file-error? 6:floor
  ...
  6:rationalize read-bytevector read-bytevector! 5:read-char read-error? r:read-line r:read-string
  read-u8 6:real? 5:remainder 6:reverse 6:round 6:set! 5:set-car! 5:set-cdr! square 6:string
  6:string->list 6:string->number 6:string->symbol string->vector 6:string-append 6:string-copy
  r:string-copy! 5:string-fill! 6:string-for-each 6:string-length string-map 6:string-ref
  5:string-set! 6:string<=? 6:string<? 6:string=? 6:string>=? 6:string>? 6:string? 6:substring
  6:symbol->string 6:symbol=? 6:symbol? syntax-error 6:textual-port? 6:truncate truncate-quotient
  truncate-remainder truncate/ u8-ready? 6:unless 6:unquote 6:unquote-splicing 6:values 6:vector
  6:vector->list vector->string r:vector-append r:vector-copy r:vector-copy! 6:vector-fill!
...
(define-syntax-rule (read-error? . _)
  (syntax-error "FIXME: not yet implemented"))
